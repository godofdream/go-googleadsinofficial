...
type GetPendingInvitations struct {
	XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/mcm/v201809 getPendingInvitations"`
...
type GetPendingInvitationsResponse struct {
	XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/mcm/v201809 getPendingInvitationsResponse"`
...
type MutateLabel struct {
	XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/mcm/v201809 mutateLabel"`
...
type MutateLabelResponse struct {
	XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/mcm/v201809 mutateLabelResponse"`

	Rval *ManagedCustomerLabelReturnValue `xml:"rval,omitempty"`
}

type MutateLink struct {
	XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/mcm/v201809 mutateLink"`
...
type MutateLinkResponse struct {
	XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/mcm/v201809 mutateLinkResponse"`

	Rval *MutateLinkResults `xml:"rval,omitempty"`
}

type MutateManager struct {
	XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/mcm/v201809 mutateManager"`
...
type MutateManagerResponse struct {
	XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/mcm/v201809 mutateManagerResponse"`
...
type ManagedCustomerServiceInterface interface {
	...
	*/
	...
	/*
	   ...
	   @throws ApiException when there is at least one error with the request
	*/
	GetPendingInvitations(request *GetPendingInvitations) (*GetPendingInvitationsResponse, error)
	...
	*/
	MutateLink(request *MutateLink) (*MutateLinkResponse, error)
	...
	/*
	   ...
	   @throws ApiException with a {@link ManagedCustomerServiceError}
	*/
	MutateManager(request *MutateManager) (*MutateManagerResponse, error)
}
...
func NewManagedCustomerServiceInterface(client *soap.Client) ManagedCustomerServiceInterface {
