...
type OfflineCallConversionFeedServiceInterface interface {
...
func NewOfflineCallConversionFeedServiceInterface(client *soap.Client) OfflineCallConversionFeedServiceInterface {
