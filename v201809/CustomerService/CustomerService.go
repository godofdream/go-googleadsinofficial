...
type GetCustomers struct {
	XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/mcm/v201809 getCustomers"`
}

type GetCustomersResponse struct {
	XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/mcm/v201809 getCustomersResponse"`

	Rval []*Customer `xml:"rval,omitempty"`
}

type GetServiceLinks struct {
	XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/mcm/v201809 getServiceLinks"`
...
type GetServiceLinksResponse struct {
	XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/mcm/v201809 getServiceLinksResponse"`
...
type MutateServiceLinks struct {
	XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/mcm/v201809 mutateServiceLinks"`
...
type MutateServiceLinksResponse struct {
	XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/mcm/v201809 mutateServiceLinksResponse"`
...
type CustomerServiceInterface interface {
	...
	*/
	GetCustomers(request *GetCustomers) (*GetCustomersResponse, error)
	...
	/*
	   ...
	   @throws ApiException
	*/
	GetServiceLinks(request *GetServiceLinks) (*GetServiceLinksResponse, error)
	...
	*/
	...
	/*
	   ...
	   @throws ApiException
	*/
	MutateServiceLinks(request *MutateServiceLinks) (*MutateServiceLinksResponse, error)
}
...
func NewCustomerServiceInterface(client *soap.Client) CustomerServiceInterface {
