...
type CustomerNegativeCriterionServiceInterface interface {
...
func NewCustomerNegativeCriterionServiceInterface(client *soap.Client) CustomerNegativeCriterionServiceInterface {
