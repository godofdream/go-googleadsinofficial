...
const (
	...
	//
	CampaignGroupStatusREMOVED CampaignGroupStatus = "REMOVED"
)
...
type CampaignGroupServiceInterface interface {
...
func NewCampaignGroupServiceInterface(client *soap.Client) CampaignGroupServiceInterface {
