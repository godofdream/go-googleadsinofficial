...
type Get struct {
	XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/mcm/v201809 get"`

	Selector *Selector `xml:"selector,omitempty"`
}

type GetResponse struct {
	XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/mcm/v201809 getResponse"`

	Rval *AccountLabelPage `xml:"rval,omitempty"`
}

type Mutate struct {
	XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/mcm/v201809 mutate"`
...
type MutateResponse struct {
	XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/mcm/v201809 mutateResponse"`
...
type AccountLabelServiceInterface interface {
...
func NewAccountLabelServiceInterface(client *soap.Client) AccountLabelServiceInterface {
