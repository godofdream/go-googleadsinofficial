...
type FeedItem struct {
	...
	//
	// Summary of a feed item's offline validation, policy findings, and approval results for active
	// feed mappings.
	// <span class="constraint Selectable">This field can be selected using the value "PolicySummaries".</span>
	// <span class="constraint ReadOnly">This field is read only and will be ignored when sent to the API.</span>
	//
...
func NewFeedItemServiceInterface(client *soap.Client) FeedItemServiceInterface {
